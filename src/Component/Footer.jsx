...
const Footer = () => {
  return (
    <footer className="w-full py-10 px-24 border-t border-muted bg-white/30 dark:bg-gray-900/30 backdrop-blur-md">
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4 text-purple-500 text-xl">
              <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer">
                <FaGithub className="hover:text-purple-700 transition" />
              </a>
              <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className="hover:text-purple-700 transition" />
              </a>
              <a href="https://twitter.com/yourusername" target="_blank" rel="noopener noreferrer">
                <FaTwitter className="hover:text-purple-700 transition" />
              </a>
              <a href="mailto:youremail@example.com">
                <FaEnvelope className="hover:text-purple-700 transition" />
              </a>
            </div>
          </div>
        </div>
